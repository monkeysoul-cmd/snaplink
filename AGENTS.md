...
- **Auto-Push Rule**: After completing and verifying any code modifications (typechecks, builds, tests), always automatically stage, commit with a descriptive message, and push the changes to GitHub (`origin <current-branch>` and `origin main`).
